...
export default function Galaxy({
  ...
  useEffect(() => {
    ...
    program = new Program(gl, {
      ...
      uniforms: {
        ...
        uDensity: { value: adjustedDensity },
        uHueShift: { value: hueShift },
        uSpeed: { value: speed },
        uMouse: {
          value: new Float32Array([smoothMousePos.current.x, smoothMousePos.current.y]),
        },
        uGlowIntensity: { value: adjustedGlow },
        uSaturation: { value: saturation },
        uMouseRepulsion: { value: mouseRepulsion },
        uTwinkleIntensity: { value: adjustedTwinkle },
  ...
  return (
    <div 
      ref={ctnDom} 
      className={`absolute inset-0 ${rest.className || ''}`}
      {...Object.fromEntries(Object.entries(rest).filter(([key]) => key !== 'className'))}
    />
  );
}
